...
uint16_t freqInMhzToNearestFreqCode(uint16_t freqVal, boolean upFlag, char *outStr);
uint16_t incDecFreqCodeValue(uint16_t codeWordVal, boolean bandFlag, boolean upFlag);
